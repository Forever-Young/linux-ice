...
md5sums=('0ecbaf65c00374eb4a826c2f9f37606f'
         ...
         '27f05b52645f6e56530d29ae4beadf87'
         '6146c2663455b56dc05cd6b68c718c59')
...
prepare() {
  ...
  # tuxonice fix
  # http://lists.tuxonice.net/pipermail/tuxonice-devel/2014-January/007446.html
  patch -p1 -i "${srcdir}/atomic_copy_fix.patch"
