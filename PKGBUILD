# $Id: PKGBUILD 192498 2013-08-13 09:58:25Z tpowa $
...
pkgver=3.12.2
pkgrel=1
_toipatch=tuxonice-for-linux-3.12.2-2013-11-30.patch
arch=('i686' 'x86_64')
...
md5sums=('cc6ee608854e0da4b64f6c1ff8b6398c'
         ...
         '7d03e3fa734cde6ff8756179236cd005'
         'cd9e434ef27bd2e10706860b7c3c547d'
         '19bef52e7d4af6f18db09f882f0d1a42')
...
prepare() {
  ...
  # fix i915 drm driver on Asus Zenbook
  # patch from http://www.spinics.net/lists/intel-gfx/msg33592.html
  patch -Np1 -i "${srcdir}/fix_i915.patch"

  # Fix s2disk image resume using patch by Al Viro, do not lock when UMH is waiting on current thread spawned by linuxrc; should be safe, will do more testing with next version bump. (gentoo bug #481344)
  patch -Np1 -i "${srcdir}/s2disk-resume-image-fix.patch"
...
build() {
  ...
  # get kernel version
  yes ""|make oldconfig
  sed -i -e 's/local\/sbin\/tuxoniceui_text/bin\/tuxoniceui/g' .config
